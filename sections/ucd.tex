...
The statements \glqq I would argue that Discord is also a social media platform [...]\grqq{} and \glqq [...] WhatsApp if that counts\grqq{} are strong an indication of this[T18ff][T222].
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=0.7, font=\footnotesize]
        \pie[text=legend]{17.65/Study-subject, 17.65/General info, 11.77/Specialization, 11.77/Pseudonym, 11.77/Semester, 11.77/Role, 11.77/CV, 5.88/Course of studies}
    \end{tikzpicture}
...
According to the interview results, ex-students should also be severely restricted[T72ff][T255ff].
...
Another concern is the issue of spreading misinformation[T144].
